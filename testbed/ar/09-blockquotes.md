---
title: الاقتباسات - الأساسية والمتداخلة
categories:
  - markdown
  - blockquotes
tags:
...
## Blockquote with Horizontal Rules
...
## Nested Blockquotes with Content
...
## Blockquote with Escaped Characters
...
## Blockquote Starting Document

> This blockquote starts the document.

---

## Blockquote Ending Document
...
## Blockquote with Attribution (if supported)
...
## Blockquote with Citation (if supported)
...
## Blockquote with Complex Nesting
...
## Blockquote with Multiple Paragraphs and Lists
...
## Blockquote with Tables and Lists
...
## Blockquote with Headers and Content
...
## Blockquote Preserving Formatting
...
## Blockquote with GitHub Flavored Markdown Features
...
## Blockquote with Reference Links
...
## Blockquote with Images and Links
...
## Blockquote with Mixed Inline Elements
...
## Blockquote with Special Punctuation
...
## Blockquote with Very Long Words

> Blockquote with verylongwordthatextendsbeyondnormalwidth and anotherverylongword.

---

## Blockquote with Preserved Whitespace (if supported)
...
## Blockquote with Mixed Languages

> Blockquote with English, français, español, and 中文.

---

## Blockquote with Mathematical Expressions (if supported)
